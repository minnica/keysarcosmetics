...
6. Responde exclusivamente el JSON del schema proporcionado, con taskId exacto, outcome, summary, checks, remaining y nextStep. Cada check debe indicar un comando real, resultado y evidencia concreta. No afirmar pruebas omitidas como aprobadas.
