...
| B03 | RV3 cubre identidad, perfil, fusión y campos; importación de clientes, audiencias y reporte de fichas permanecen visibles sin simulación. Continúan además archivos masivos de precios, grupos/especialidades completos, horarios de recursos, encuestas, consentimientos/plantillas y gift cards de servicio. | Cobertura API/UI               | Parcial RV3; continuar RV4/RV6                  |
