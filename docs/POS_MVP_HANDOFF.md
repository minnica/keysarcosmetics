...
- Checkpoint actual: `RV5-P1`, parcial. Además de minorista y adeudos no ambiguos, las revisiones de membresías con la misma composición ya conservan el tarjetón original y asistencias, proyectan importe/clienta por versión, registran el cambio de vendedor y recuperan el importe efectivo en Membresías, exportación y X-Report.
- Siguiente trabajo: continuar RV5-P1 con altas/bajas/sustituciones de tarjetones sólo cuando el control aprobado permita identificar unidades; después coordinar Agenda, paquetes/cortesías, participación de empresa y adeudos duplicados ambiguos. Esos casos mantienen `409` previo a autorización. Certificar los consumidores transversales restantes y seguir RV6-P1/P2 según la sección 6 del plan. La revisión del PO y sus decisiones quedan aplazadas; `12fb804` basta como dirección visual.
...
## Checkpoint RV5-P1 (2026-09-16, ejecución actual — membresías y sesiones)
