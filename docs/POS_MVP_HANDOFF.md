...
- Checkpoint actual: `RV5-P1`, parcial. Además de las revisiones minoristas, los adeudos no ambiguos ya conservan entregas append-only, impiden reducir cantidades surtidas, actualizan cantidad/estado y calculan inventario sólo sobre unidades físicamente comprometidas dentro de la transacción idempotente.
- Siguiente trabajo: continuar RV5-P1 con membresías, Agenda, paquetes/cortesías, participación de empresa y adeudos duplicados que no pueden asignarse sin ambigüedad; esos casos fallan explícitamente con `409` antes de consumir autorización. Certificar después segundas revisiones, saldos, reportes y exportaciones, y seguir RV6-P1/P2 según la sección 6 del plan. La revisión del PO y sus decisiones quedan aplazadas; `12fb804` basta como dirección visual.
...
## Checkpoint RV5-P1 (2026-09-16, ejecución actual — adeudos y entregas)
