...
- **Decisión vigente de presentación y entrega (2026-09-09):** la única referencia visual aprobada por el usuario es el árbol completo de `feature/pos` en `12fb8045cc264b565cb6e764d95ad7b2447fbfa1`, incluidos sus módulos nuevos. `8fd71f3` es sólo histórico. El MVP online de RV0–RV7, RV9 bloqueante y RV10 quedó implementado y validado técnicamente; RV3 espera sólo la decisión de copy B01 y RV10 sólo la aceptación del PO. RV8, offline, hardware, pilotos, escala y endurecimiento exhaustivo están en backlog post-MVP. Conservar exactamente esa presentación e interacción, reutilizar/adaptar/completar backend y retirar implementaciones incompatibles sólo con consumidores verificados y datos preservados. No inventar pantallas, añadir campos ni ocultar acciones para acomodar contratos existentes. Evidencia: `docs/POS_MVP_ONLINE_DELIVERY.md`.
