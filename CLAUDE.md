...
- La page `/gastos` contiene exactamente dos tablas visibles: **Gastos**, cuya vista principal es **Recurrentes activos** y deja **Historial** como consulta secundaria para no presentar una serie y su ocurrencia como cargos duplicados, y **Categorías de gasto**, con acciones de edición y eliminación lógica. Las métricas cambian con la vista: programación activa frente a aplicaciones reales de los últimos 12 meses.
