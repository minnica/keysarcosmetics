...
- **Decisión vigente de presentación (2026-09-08):** la única referencia visual aprobada por el usuario es el árbol completo de `feature/pos` en `12fb8045cc264b565cb6e764d95ad7b2447fbfa1`, incluidos sus módulos nuevos. `8fd71f3` es sólo histórico. El plan de ejecución está en `PLAN_RESTAURACION_VISUAL_POS.md`: RV0 y RV1 quedaron completadas; RV2–RV10 permanecen pendientes. Conservar exactamente esa presentación e interacción, reutilizar/adaptar/completar backend y retirar las implementaciones incompatibles verificando consumidores y preservando datos. No inventar pantallas, añadir campos ni ocultar acciones para acomodar contratos existentes. Esta decisión prevalece sobre descripciones visuales históricas de este archivo y del plan anterior.
