...
>
> Este archivo es el contexto técnico del repositorio para agentes de opencode/Codex. `CLAUDE.md` es el contexto equivalente para Claude Code; ambos son complementarios, no duplicados.
