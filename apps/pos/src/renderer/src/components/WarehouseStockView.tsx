...
export function WarehouseStockView({
  ...
  const saveItem = () => {
    if (itemDraft && onSaveSupply(itemDraft)) setItemDraft(null);
  };
        ...
        <CardContent>
          <div className="warehouse-panel-heading">
            <div>
              ...
              <h2>Existencias del almacén matriz</h2>
              <p>
            ...
            <div>
              ...
              <Button
                ...
                aria-label="Descargar existencias en PDF"
                title="PDF"
              >
                <FileDown size={16} />
              </Button>
              <Button size="icon" variant="outline" className="icon-action-button" onClick={() => window.print()} aria-label="Imprimir existencias" title="Imprimir">
                <Printer size={16} />
              </Button>
              {canManage && (
                <>
                  <Button variant="outline" onClick={openRestock}>
                    <RefreshCw size={16} /> Generar compra a proveedor
                  </Button>
                </>
              )}
            </div>
                  ...
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline">
                        {row.source === "SUPPLY" ? "Editar en Proveedores" : "Editar en Catálogo"}
                      </Badge>
                    </TableCell>
                  </TableRow>
                ))}
      ...
      >
        <DialogContent className="sm:max-w-[850px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Captura proveedor, costos, costo interno, unidad, presentación y
              límites de stock.
            </DialogDescription>
          </DialogHeader>
          {itemDraft && (
