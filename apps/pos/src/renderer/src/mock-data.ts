...
export const products: Product[] = [
  ...
  {
    id: "membership-ritual-glow",
    name: "Membresía Ritual Glow",
    sku: "MEM-GLW-008",
    family: "Membresías",
    category: "Faciales",
    group: "Membresías de servicio",
    kind: "MEMBERSHIP",
    image: "./products/signature-facial.png",
    description:
      "Programa personalizado de ocho sesiones faciales con seguimiento de asistencia y evolución de la clienta.",
    benefits: [
      "8 sesiones registradas en tarjetón digital",
      "Seguimiento desde la agenda",
      "Alertas antes de agotar las sesiones",
    ],
    showInDigitalCatalog: true,
    minPrice: 6500,
    maxPrice: 7200,
    ...
    branches: ["Polanco", "Satélite", "Roma Norte"],
    active: true,
    membershipSessions: 8,
  },
  {
    id: "membership-signature-12",
    name: "Membresía Signature 12",
    sku: "MEM-SIG-012",
    family: "Membresías",
    category: "Faciales",
    group: "Membresías de servicio",
    ...
    image: "./products/signature-facial.png",
    description:
      "Experiencia anual de doce sesiones con control de uso, agenda y tarjetón individual por compra.",
    benefits: [
      "12 sesiones individualizadas",
      "Historial de asistencias por sucursal",
      "Preparada para firma táctil",
    ],
    showInDigitalCatalog: true,
    minPrice: 9200,
    maxPrice: 10200,
...
export const initialReceiptSettings: ReceiptSettings = {
  ...
  companySalesNumber: "EMPRESA-001",
...
export const initialAppointments: Appointment[] = [
  {
    id: "appointment-membership-valeria-cancelled-1",
    kind: "NEXT_SESSION",
    service: "Membresía Ritual Glow",
    date: "2026-08-10",
    branch: "Polanco",
    time: "16:00",
    clientId: "client-1",
    ...
    recordedAt: "08 ago 2026 · 13:20",
    recordedAtIso: "2026-08-08T13:20:00-06:00",
    status: "CANCELLED",
    membershipId: "membership-card-valeria-glow-1",
    agendaClientId: "crm-client-client-1",
    agendaReservationId: "crm-reservation-valeria-cancelled-1",
    externalAppointmentId: "crm-appointment-valeria-cancelled-1",
    agendaSyncStatus: "CANCELLED",
    agendaSyncedAtIso: "2026-08-09T17:30:00-06:00",
  },
  {
    id: "appointment-membership-valeria-no-show-2",
    kind: "NEXT_SESSION",
    service: "Membresía Ritual Glow",
    date: "2026-08-17",
    branch: "Polanco",
    ...
    ticketId: "KSR-0901",
    sellerIds: ["seller-ana"],
    recordedAt: "15 ago 2026 · 10:05",
    recordedAtIso: "2026-08-15T10:05:00-06:00",
    status: "NO_SHOW",
    membershipId: "membership-card-valeria-glow-1",
    agendaClientId: "crm-client-client-1",
    agendaReservationId: "crm-reservation-valeria-no-show-2",
    externalAppointmentId: "crm-appointment-valeria-no-show-2",
    agendaSyncStatus: "NO_SHOW",
    agendaSyncedAtIso: "2026-08-17T12:05:00-06:00",
  },
  {
    ...
    payments: [
      {
        ...
        methodId: "CARD",
        amount: 1760,
        cardOrBank: "BBVA México",
        bankName: "BBVA México",
        cardNetwork: "VISA",
        cardType: "CREDIT",
        installmentMonths: 6,
        authorizationCode: "1047",
      },
    ],
    amountPaid: 1760,
    balanceDue: 0,
