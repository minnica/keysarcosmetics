  ...
  theme: {
    extend: {
      colors: {
        ...
        // Tokens semanticos de marca (legacy - no eliminar)
        ...
        // Tokens shadcn/ui - mapeados a CSS vars de marca
        // Los componentes shadcn usan estas claves de Tailwind.
        // Las vars de marca en globals.css no se modifican.
        ...
        ring:          'var(--accent)',
        // Tokens para el Sidebar oficial shadcn/ui — mapeados a vars de marca
        sidebar: {
