...
const translations = {
  es: {
    ...
    access: {
      ...
      description: 'Define qué pantallas puede ver cada puesto y administra las credenciales de acceso.',
  ...
  en: {
    ...
    access: {
      ...
      description: 'Define which screens each position can see and manage employee credentials.',
