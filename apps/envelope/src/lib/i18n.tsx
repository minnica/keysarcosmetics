...
const translations = {
  es: {
    ...
    access: {
      ...
      accountDeleteHint: 'El empleado seguirá existiendo; solo se desactiva el acceso.',
      deleteAccountTitle: '¿Desactivar cuenta de acceso?',
      deleteAccountDescription: 'Se desactivará el acceso de',
      deleteAccountCta: 'Desactivar cuenta',
      accountDeleted: 'Cuenta desactivada',
  ...
  en: {
    ...
    access: {
      ...
      accountDeleteHint: 'The employee will remain; only the login access is disabled.',
      deleteAccountTitle: 'Disable access account?',
      deleteAccountDescription: 'The login access will be disabled for',
      deleteAccountCta: 'Disable account',
      accountDeleted: 'Account disabled',
