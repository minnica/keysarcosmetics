  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Espacio fantasma para que el contenido no quede debajo */}
        <div
          className={cn(
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'group-data-[side=left][data-state=collapsed]_&]:-translate-x-full',
          className
        )}
        {...props}
      />
...
const sidebarMenuButtonVariants = cva(
  [
    ...
    // Transición sincronizada con el contenedor del sidebar (duration-200 ease-linear)
    ...
    // Collapsed: botón cuadrado; el span de texto se desvanece antes que el ancho termine
    'group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2',
    '[&>svg]:size-4 [&>svg]:shrink-0',
    // El span de label se desvanece rápido (100ms) para no verse recortado durante la animación de width
    '[&>span:last-child]:truncate',
    '[&>span:last-child]:transition-[opacity] [&>span:last-child]:duration-100 [&>span:last-child]:ease-linear',
      ...
      >
        {showIcon && (
          <div
            ...
            className="size-4 rounded-md bg-sidebar-accent animate-pulse shrink-0"
          />
        )}
        <div
